...
class DashboardApp:
    ...
    def sign_out(self):
        ui.link('Log Out', 'http://127.0.0.1:8080/login').props('rounded').classes(
    ...
    def create_sidebar(self):
        ...
        with ui.column().classes('w-64 h-screen').style(sidebar_style):
            ...
            with ui.row().classes('mt-auto p-4 w-full items-center justify-between'):
                ...
                #    'btn btn-primary w-auto bg-blue-500 hover:bg-blue-700 text-white no-underline px-4 py-2 rounded-md'
                #        )
            ...
            with ui.row().classes('items-center justify-between mb-8'):
                with ui.column():
                    ...
                    if usname != None:
                        ...
                        ui.label('Please, login').classes('text-3xl font-bold text-gray-800')
    ...
    def create_page(self, url: str, title: str, content_callback=None):
        ...
        def page():
            ...
            bg_path = db_pth=  os.path.join(os.path.dirname(__file__), "bg.jpg")
...
app = DashboardApp()
app.create_page('/home', app.create_main_content)
